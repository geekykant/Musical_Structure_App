...
# Musical_Structure_App
Musical Structural app is one of the project of Udacity's Android Basics Nanodegree Course. The remaining projects can be found here.

# License
This project is licensed under Apache License. See the <a href="https://github.com/geekykant/Musical_Structure_App/blob/master/LICENSE">LICENSE</a> for details.
